...
const url = `http://127.0.0.1:5173/templates/_diag/render-only.html?file=${encodeURIComponent(file)}&subdir=${encodeURIComponent(subdir)}`;
...
(async () => {
  ...
  console.log('=== Native header border/underline elements (before fallback) ===');
